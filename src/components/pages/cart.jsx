...
import { clearCart, removeItem , plusItem, minusItem } from '../../redux/actions/cart';
...
function Cart() {
 ...
 const dispatch = useDispatch();
  ...
  const {items, totalPrice, itemCount} = useSelector(({cart}) => cart)
        ...
        <div className="content__items">
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
                <span> Всего пицц: <b>{itemCount} шт.</b> </span>
